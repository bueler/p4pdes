...
\begin{quote}
	...
	\end{enumerate}
\end{quote}
The issue raised in (\emph{ii})c, and also the possible step-length reduction in (\emph{iii}), will be addressed starting on page \pageref{sec:JFNKandlinesearch}.
...
\section{Jacobian-free Newton-Krylov, and line search} \label{sec:JFNKandlinesearch}
...
This example shows a famous case where the no-linesearch Newton iteration can diverge or even enter a limit cycle according to the initial iterate $x_0$.  Linesearch fixes this.
    \begin{enumerate}
