...
\cinputpart{c2prealloc.c}{Read \pVec s from file and set up \pMat $A$.}{I}{//STARTREAD}{//STARTNNZ}

\cinputpart{c2prealloc.c}{Loop over all elements to preallocate.}{II}{//STARTNNZ}{//ENDELEMENTSLOOP}

\cinputpart{c2prealloc.c}{Loop over all boundary segments to preallocate.}{III}{//ENDELEMENTSLOOP}{//ENDBDRYLOOP}

\cinputpart{c2prealloc.c}{Actually preallocate the \pMat in parallel. Fill it with junk entries so the pattern can be visualized.}{IV}{//STARTPREALLOC}{//ENDPREALLOC}
