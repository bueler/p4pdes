...
\cinputpart{readmesh.c}{Determine filename of \PETSc binary file that has the mesh.}{I}{//STARTGET}{//ENDGET}

\cinputpart{readmesh.c}{Read the mesh in parallel, but put a sequential copy of index arrays on each processor.}{II}{//ENDGET}{//END}
...
\cinputpart{c2prealloc.c}{Loop over all elements to preallocate.}{I}{//STARTNNZ}{//ENDELEMENTSLOOP}

\cinputpart{c2prealloc.c}{Loop over all boundary segments to preallocate.}{II}{//ENDELEMENTSLOOP}{//ENDBDRYLOOP}

\cinputpart{c2prealloc.c}{Actually preallocate the \pMat in parallel.}{III}{//STARTPREALLOC}{//ENDPREALLOC}
