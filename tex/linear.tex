...
In these terms, and recalling the change-of-variables formula for integrals,
\begin{align*}
\text{\texttt{a(k,q,r)}} &= \int_{\triangle} \grad\phi_q \cdot \grad\phi_r \\
   ...
   &= \int_{\triangle_\ast} \left(\frac{\partial \chi_q}{\partial \xi} \frac{\partial \xi}{\partial x} + FIXME \right) \; \det(J) \; d\xi \, d\eta \\
   &= 
\end{align*}
