...
Code \ref{code:poissonexactrhs} shows how \eqref{exactsolution} is implemented as \texttt{formExact()} and how \eqref{manufacturedf} is implemented as \texttt{formRHS()}.  We will reuse these parts in Chapters \ref{chap:mg} and \ref{chap:sc}.
