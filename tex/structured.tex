...
\end{cline}
%$
distributes a $9\times 9$ grid among four processes.  Figure \ref{fig:unitsquaregrideight} shows the balanced result of ``\texttt{mpiexec -n 4 ./poisson -da\_grid\_x 10 -da\_grid\_y 10}'' with each rank owning a square subgrid of 25 nodes.
...
So at this point we have some confidence that we can control our code at runtime.  Here is what we want to know:\begin{itemize}
