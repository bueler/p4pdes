...
\begin{tikzpicture}[scale=4.5]
  \draw[xstep=0.1,ystep=0.1,gray,thin] (0.0,0.0) grid (0.9,0.9);
  ...
  \node at (0.3,-0.06) {$i=$\texttt{info.xs}};
  \draw[<->,] (0.3,0.2-0.04) -- (0.7,0.2-0.04);
  \node at (0.5,0.2-0.08) {\texttt{info.xm}};
  \node[rotate around={90:(-0.2,0.2)}] at (-0.1,0.1) {$j=$\texttt{info.ys}};
  \draw[<->,] (0.3-0.04,0.2) -- (0.3-0.04,0.6);
  \node[rotate around={90:(0.3-0.3,0.4)}] at (0.3-0.18,0.3) {\texttt{info.ym}};
\end{tikzpicture}
\caption{How \texttt{DMDALocalInfo info} describes your local process' part of the grid.}
