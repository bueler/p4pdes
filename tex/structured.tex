...
\renewcommand{\intime}[1]{\input{../c/ch3/timing/poisson/#1}}
\begin{figure}[ht]
\texttt{
\begin{tabular}{llll}
...
gmres      & none        & \intime{gmres.none} \\
           ...
           & ilu \emph{restart} & \intime{gmres.ilu.restart} \\
cg         & none        & \intime{cg.none} \\
           & jacobi      & \intime{cg.jacobi} \\
           & icc         & \intime{cg.icc} \\
           & icc \emph{tight} & \intime{cg.icc.tight} \\
minres     & none        & \intime{minres.none} \\
preonly    & cholesky    & \intime{preonly.cholesky}  \\
\end{tabular}
}
\caption{Times and number of \pKSP iterations for serial runs of \texttt{poisson.c} on grids of $6.6\times 10^3$ unknowns.  The matrix is \emph{symmetric}, \emph{diagonally-dominant}, and \emph{positive definite}.  All runs were on \WORKSTATION (see page \pageref{defineworkstation}).} \label{tab:poissontiming}
\end{figure}
