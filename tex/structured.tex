...
Recalling the $M=5$, $N=7$ grid in Figure \ref{fig:unitsquaregrid}, we can now examine both the grid (i.e.~the \pDM object) and the generated matrix graphically at runtime.  That is, if X11 or other windowing is correctly linked in your \PETSc installation then
\begin{cline}
...
We check convergence by generating error data.  Here is a Bash loop:
\begin{cline}
