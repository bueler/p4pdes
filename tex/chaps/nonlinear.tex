...
\path
   ...
   (ksp) edge node {} (pc);
\end{tikzpicture}
\caption{An overview of \texttt{reaction.c}, our first structured-grid solution of a nonlinear PDE using \PETSc.  Arrows should be read as ``user code acts directly on.''}
