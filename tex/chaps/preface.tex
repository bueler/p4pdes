...
\item  does not prove anything of any consequence,\sidenote{Theorems are stated precisely when appropriate.  In computational examples we give evidence, when possible, for convergence and scalability.} and
...
\end{quote}
is required before compiling and running the examples in this book.  The configuration process finds the compiler and enables ``\texttt{make}'' as a build command, or it fails.\sidenote{The \PETSc team will help with failed installation attempts.  See \href{http://www.mcs.anl.gov/petsc/documentation/bugreporting.html}{\texttt{www.mcs.anl.gov/petsc/ documentation/bugreporting.html}}.}
