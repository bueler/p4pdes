...
Using \eqref{eq:ok:smallexpansionvelocity} and \eqref{eq:ok:smallexpansionpressure} with test functions $\bv_i$ in \eqref{eq:ok:weakstokesvelocity}, it is easy to show that we have
\begin{align}
...
\end{align}
for $i=0,1,2,3$.  Similarly, using \eqref{eq:ok:smallexpansionvelocity} in \eqref{eq:ok:weakstokespressure} with test functions $q_i$ we have four more equations,
\begin{align}
\alpha_0 \int_{\square_0} \frac{\partial \psi_0}{\partial x} + \hspace{21mm} \beta_0 \int_{\square_0} \frac{\partial \psi_0}{\partial y} \hspace{21mm} &= - \int_{\square_0} \frac{\partial \psi_{-1}}{\partial x}, \notag \\ 
\alpha_0 \int_{\square_1} \frac{\partial \psi_0}{\partial x} + \alpha_1 \int_{\square_1} \frac{\partial \psi_1}{\partial x} + \beta_0 \int_{\square_1} \frac{\partial \psi_0}{\partial y} + \beta_1 \int_{\square_1} \frac{\partial \psi_1}{\partial y} &= 0, \notag \\
\alpha_0 \int_{\square_2} \frac{\partial \psi_0}{\partial x} + \hspace{21mm} \beta_0 \int_{\square_2} \frac{\partial \psi_0}{\partial y} \hspace{21mm} &= - \int_{\square_2} \frac{\partial \psi_{-1}}{\partial x}, \notag \\
\alpha_0 \int_{\square_3} \frac{\partial \psi_0}{\partial x} + \alpha_1 \int_{\square_3} \frac{\partial \psi_1}{\partial x} + \beta_0 \int_{\square_3} \frac{\partial \psi_0}{\partial y} + \beta_1 \int_{\square_3} \frac{\partial \psi_1}{\partial y} &= 0. \label{eq:ok:smallconcretepressure}
\end{align}
