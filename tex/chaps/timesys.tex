...
Finally, one can distinguish between the two implicit methods above by a concept which generalizes absolute stability.  A scheme has \emph{stiff decay} if 

FIXME

when it is applied to the modified test problem
