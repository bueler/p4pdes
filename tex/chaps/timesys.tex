...
The very well-known fourth-order Runge-Kutta method has four stages.  Instead of stating this scheme with formulas like those above, we say that a multi-stage
...
$c_2$    & $a_{21}$ \\
$c_3$    & $a_{31}$ & $a_{32}$ \\
$c_s$    & $a_{s1}$ & $a_{s2}$  & $a_{s,s - 1}$  \\ \hline
         & $b_1$    & $b_2$     & $b_{s-1}$     & $b_s$
\end{tabular}
