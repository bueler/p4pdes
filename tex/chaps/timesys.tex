...
The very well-known fourth-order Runge-Kutta method has four stages.  Instead of stating this scheme with formulas like the above, we describe a one-step, multi-stage method
\begin{align}
