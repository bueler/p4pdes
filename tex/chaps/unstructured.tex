...
\end{equation}
FIXME Moving the known Dirichlet data to the right, and using expansions \eqref{eq:un:hatgdefine} and \eqref{eq:un:uhexpand}, gives
\begin{align}
