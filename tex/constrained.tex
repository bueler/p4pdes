...
\cinputpart{c9obstacle.c}{Important part: tell SNESVI object about bound $u\ge \psi$ (and $u<+\infty$ because SNESVI expects both upper and lower bounds).}{IV}{//FORMBOUNDS}{//ENDFORMBOUNDS}{code:obstacleformbounds}

\cinputpart{c9obstacle.c}{Solve and report on results.}{V}{//SOLVE}{//ENDSOLVE}{code:obstaclesolve}
