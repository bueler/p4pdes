...
\vfill
\clearpage
\inputwhole{../c/ch2/vecmatksp.c}{\texttt{ch2/vecmatksp.c}}{Solve a small linear system.}{code:vecmatksp}
...
\vfill
\newpage
\cinputpartnostrip{../c/ch2/tri.c}{ch2/tri.c}{Set up \pVec and \pMat objects for a tridiagonal system.}{I}{//STARTSETUP}{//ENDSETUP}{code:tripartone}
...
\cinputpartnostrip{../c/ch2/tri.c}{ch2/tri.c}{Assemble and solve.}{II}{//ENDSETUP}{//ENDSOLVE}{code:triparttwo}
