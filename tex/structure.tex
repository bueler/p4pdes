...
\newcommand{\cinputraw}[5]{  
\renewcommand*\FancyVerbStartString{#4}
\renewcommand*\FancyVerbStopString{#5}
\begin{figure*}
\vspace{0.8cm}
...
\newcommand{\cinput}[4]{\cinputraw{#1}{#2}{}{#3}{#4}}
\newcommand{\cinputpart}[5]{\cinputraw{#1}{#2}{\quad \textbf{part #3}}{#4}{#5}}
\newcommand{\cinputfull}[2]{\cinput{#1}{#2}{}{VERYUNLIKELYSTRING314159}}
...
\cinputpart{c1matvec.c}{Initialize \PETSc and allocate \pVec s and \pMat.}{I}{}{//ENDSETUP}

\cinputpart{c1matvec.c}{Assemble \pMat $A$ and right-hand side $b$.}{II}{//ENDSETUP}{//ENDASSEMBLY}

\cinputpart{c1matvec.c}{Set up \pKSP.  Solve.  Finalize.}{III}{//ENDASSEMBLY}{//END}
