...
\newtheorem*{theorem}{{\color{cyan} Theorem}}
...
\newcommand{\cinputpartnostrip}[7]{%
    \cinputraw{../#2#1}{#2#1}{#3}{\quad \textbf{part #4}}{#5}{#6}{#7}}
...
\input{nonlinear.tex} % chapter 4

\input{optifem.tex} % chapter 5

\input{multigrid.tex} % chapter 6

\input{scaling.tex} % chapter 7

\input{unstructured.tex} % chapter 8

\input{stokes.tex} % chapter 9

\input{dmplex.tex} % chapter 10

\input{constrained.tex} % chapter 11
