...
for (( Z=2; Z<=$MAXLEV; Z++ )); do
    ...
    cmd="../ad3 -ad3_eps 0.1 -ad3_limiter none -da_grid_x 4 -da_grid_y 3 -da_grid_z 4 -da_refine ${Z} -ksp_type bcgs -ksp_rtol 1.0e-9 -ksp_monitor -ksp_converged_reason -pc_type mg -mg_levels_ksp_type richardson -mg_levels_pc_type ilu"
    rm -f foo.txt
    echo $cmd
