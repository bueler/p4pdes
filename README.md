...
**These example programs will remain here for the long term, and they are maintained/updated for the most-recent version of PETSc.**
...
Chapters 13 and 14 use [Firedrake](https://www.firedrakeproject.org/), a [Python](https://www.python.org/) finite element library based on PETSc.  See [`MANAGING2.md`](MANAGING2.md) for suggestions on using a second PETSc installation for Firedrake.  See the [`README.md`](python/README.md) in the `python/` directory to run the Firedrake examples.
